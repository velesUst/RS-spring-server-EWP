...
import com.ewp.server.secure.jwt.HelloJwtDecoder;
...
public class TokenUtils {
    ...
    public static UserToken generateAccessToken(AuthUser user) {
    ...
    public static UserToken generateRefreshToken(AuthUser user) {
    ...
    private static UserToken generateToken(AuthUser user, Algorithm algorithm, long expire, ChronoUnit unit) {
